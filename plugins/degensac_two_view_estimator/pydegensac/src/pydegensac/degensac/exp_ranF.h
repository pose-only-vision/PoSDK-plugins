...
extern "C"
#endif
int exp_ransacFcustomLAFSeeded(double *u, double *u_1, double *u_2,int len, double th,  double laf_coef, double conf, int max_sam,
            double *F, unsigned char * inl,
            int * data_out, int do_lo, unsigned inlLimit, double **resids, double* H_best, int* Ih,exFDsPtr EXFDS1, FDsPtr FDS1, FDsidxPtr FDS1idx,  double SymCheck_th, int enable_degen_check, unsigned int random_seed);
